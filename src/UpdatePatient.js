...
function UpdatePatient() {
    ...
    function handleSubmit(event) {
        ...
        axios.put(`http://localhost:8081/update/${id}`, { name, email, age, gender, description, protocol: protocolToSubmit, physician, bodyPartExamined: bodyPartToSubmit, descriptionOfScan, date })
            .then(res => {
                console.log(res);
                navigate('/');
            })
    ...
    return (
        <div style={{ marginTop: '70px', marginBottom: '100px' }} className='d-flex vh-100 bg-white justify-content-center align-items-center'>
