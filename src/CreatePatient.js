...
function CreatePatient() {
    ...
    function handleSubmit(event) {
        ...
        axios.post('http://localhost:8081/create', { name, email, age, gender, description, protocol: protocolToSubmit, physician, bodyPartExamined: bodyPartToSubmit, descriptionOfScan, date })
            .then(res => {
                console.log(res);
                navigate('/');
            })
